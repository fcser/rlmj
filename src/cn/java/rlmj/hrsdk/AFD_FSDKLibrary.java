...
public interface AFD_FSDKLibrary extends Library {
    ...
    AFD_FSDKLibrary INSTANCE = (AFD_FSDKLibrary)LoadUtils.loadLibrary(Platform.isWindows()?"d://conf/libarcsoft_fsdk_face_detection.dll":"d://conf/libarcsoft_fsdk_face_detection.so",AFD_FSDKLibrary.class);
