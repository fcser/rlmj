...
public interface AFR_FSDKLibrary extends Library {
    AFR_FSDKLibrary INSTANCE = (AFR_FSDKLibrary)LoadUtils.loadLibrary(Platform.isWindows()?"d://conf/libarcsoft_fsdk_face_recognition.dll":"d://conf/libarcsoft_fsdk_face_recognition.so",AFR_FSDKLibrary.class);
